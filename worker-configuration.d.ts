/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: 722044a2fdac14c2442c8ff405324118)
...
interface __BaseEnv_Env {
	...
	HOST_SESSION_RATE_LIMITER: RateLimit;
	HOST_MUTATION_RATE_LIMITER: RateLimit;
	VOTE_RATE_LIMITER: RateLimit;
	ROOM_READ_RATE_LIMITER: RateLimit;
	ROOM_EVENTS_RATE_LIMITER: RateLimit;
	TURNSTILE_SITE_KEY: string;
	TURNSTILE_SECRET_KEY: string;
	TEST_BYPASS_TURNSTILE: string;
	ROOM_EVENTS: DurableObjectNamespace<import("./src/server/index").RoomEventsDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "RoomEventsDO";
	}
